...
PROJECT_DIR="/home/cs3401.58/DS_HW2/HW2/Q1"
...
echo ""
echo "--- Compiling ---"
mpicxx -O2 -std=c++17 -o src/q1_mpi     src/q1_mpi.cpp     || { echo "MPI build failed";        exit 1; }
...
# job. If your site requires srun, replace the mpirun calls in
# tests/run_tests.sh with "srun -n <P>".
echo ""
