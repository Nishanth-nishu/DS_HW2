...
Paste the runtime table from `analyze.py`.
...
- `benchmark/plots/time.png` — execution time vs P
- `benchmark/plots/speedup.png` — speed-up vs P, with the ideal line
- `benchmark/plots/efficiency.png` — efficiency vs P
- `benchmark/plots/comm_fraction.png` — communication share vs P
