...
> python3 benchmark/analyze.py > report/benchmark_results.md
> ```
...
**Verification.** `tests/run_tests.sh` compares MPI output against the
...
All regenerable via `tools/gen_graph.py` with the seeds above.

## 10. Execution time, speed-up, efficiency

Paste `benchmark/analyze.py` output here.
...
- `benchmark/plots/speedup.png`
- `benchmark/plots/efficiency.png`
- `benchmark/plots/comm_fraction.png`
